...
/**
 * <p>An abstraction of "state" (possibly between multiple distributed
 ...
 *
 * <p>Note that the semantics of 'fetch' and 'store' provide
...
public interface State {
   ...
   *
   * @return A future of an iterator of the variables names.
   */
