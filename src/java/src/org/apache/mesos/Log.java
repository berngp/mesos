 ...
 *
 * <p>Both the <i>Reader</i> and <i>Writer</i> will require a <i>quorum</i> which defines
 * the <i>ratio of active Mesos Masters</i> that need to be available for a successful
 * read or write.
 * The <i>quorum</i> will be satisfied when the number of <i>active Masters</i>
 * is greater than the given <i>number</i>:
 * <pre>{@code
 *  Quorum > (Number of Masters)/2
 * }</pre>
 *
 * <p>If a <i>read</i> or <i>write</i> is executed the operation will wait until their is
 * <i>quorum</i> to succeed.
 *
 */
public class Log {
  static {
  ...
  public static class Reader {
     ...
     * @throws OperationFailedException If the read fails due that the read no longer
     *                                  has the ability to perform its operations.
     * @see Position
     * @see TimeUnit
     */
  ...
  public static class Writer {
     ...
     * @throws WriterFailedException    If the append fails due that the writer no longer
     *                                  has the ability to perform its operations (e.g.,
     *                                  because it was superseded by another writer).
     ...
     *                                  operations (e.g., because it was superseded by
     *                                  another writer).
     */
